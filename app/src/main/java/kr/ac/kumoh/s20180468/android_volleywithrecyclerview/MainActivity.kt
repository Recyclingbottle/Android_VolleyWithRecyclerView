package kr.ac.kumoh.s20180468.android_volleywithrecyclerview
...
import kr.ac.kumoh.s20180468.android_volleywithrecyclerview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.songlist.apply {
            layoutManager = LinearLayoutManager(application) //application context 가 없어? application 쓰면 됨.
    ...
    inner class SongAdapter : RecyclerView.Adapter<SongAdapter.ViewHolder>(){
        ...
        {
            //val txText = itemView.findViewById<TextView>(android.R.id.text1) as TextView
